class CustomerEvents:
    ...
    SUCCESSFUL_LOGOUT = "succesful_logout"
    ...
    CHOICES = [
        ...
        (SUCCESSFUL_LOGOUT, "Succesfull logout"),
...
list_of_customer_events = [
    CustomerEvents.ACCESS_TOKEN_GENERATED,
    CustomerEvents.ACCESS_TOKEN_INVALIDATED,
    CustomerEvents.ACCESS_TOKEN_EXPIRED,
    CustomerEvents.REFRESH_TOKEN_GENERATED,
    CustomerEvents.REFRESH_TOKEN_EXPIRED,
    
    CustomerEvents.SIGNUP_ATTEMPT,
    CustomerEvents.SIGNUP_ATTEMPT_FAILED,
    CustomerEvents.SIGNUP_ATTEMPT_SUCCESSFUL,
    CustomerEvents.ADMIN_ACCOUNT_CREATED,
    CustomerEvents.ADMIN_ACCOUNT_VERIFIED,
    ...
    CustomerEvents.FAILED_LOGIN_ATTEMPT,
    ...
    CustomerEvents.TWO_FACTOR_FAILED,
    CustomerEvents.TWO_FACTOR_SUCCESS,
