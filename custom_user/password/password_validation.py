""" This module is used to validate the password field. It was taken 
from the Django source code and modified to fit the project's needs. """
        ...
        for attribute_name in self.user_attributes:
            ...
            for value_part in value_parts:
                ...
                if (
                    ...
                    raise serializers.ValidationError(
                        _(f"The password is too similar to the {verbose_name}."),
